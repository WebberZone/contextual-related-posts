		...
		<div class="inside">
			<div id="quick-links">
				<ul class="subsub">
					...
					<li><a href="https://webberzone.com/plugins/webberzone-link-warnings/" target="_blank"><?php esc_html_e( 'Link Warnings', 'contextual-related-posts' ); ?></a></li>
...
<div class="postbox-container">
	<div id="followdiv" class="postbox meta-box-sortables">
		...
		<a href="https://x.com/webberzone/" target="_blank"><img src="<?php echo esc_url( WZ_CRP_PLUGIN_URL . 'includes/admin/images/x.png' ); ?>" width="100" height="100"></a>
			<a href="https://facebook.com/webberzone/" target="_blank"><img src="<?php echo esc_url( WZ_CRP_PLUGIN_URL . 'includes/admin/images/fb.png' ); ?>" width="100" height="100"></a>
		</div><!-- /.inside -->
	</div><!-- /.postbox -->
</div>
