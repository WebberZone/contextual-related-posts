	...
	public static function settings_general() {
		$settings = array(
			...
			'cache_time'                   => array(
				...
				'desc'    => esc_html__( 'How long should the related posts be cached for. Default is 30 days. Set to 0 to disable expiry.', 'contextual-related-posts' ),
				'type'    => 'select',
	...
	public static function settings_list() {
		$settings = array(
			...
			'weight_content'         => array(
				...
				'desc'    => __( 'The weight to give to the post content when calculating the relevance of the post.', 'contextual-related-posts' ),
				'type'    => 'number',
				'options' => 1,
				'min'     => '0',
				'size'    => 'small',
