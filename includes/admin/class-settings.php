...
class Settings {
	...
	public static function get_settings_sections() {
		$settings_sections = array(
			'features'    => __( 'Features', 'contextual-related-posts' ),
	...
	public static function settings_output() {
		$settings = array(
			...
			'blank_output_text'     => array(
				...
				'type'    => 'textarea',
				'default' => esc_html__( 'No related posts found', 'contextual-related-posts' ),
			),
			'show_excerpt'          => array(
				'id'      => 'show_excerpt',
	...
	public static function settings_thumbnail() {
		$settings = array(
			...
			'thumb_default'      => array(
				...
				'type'    => 'file',
				'default' => WZ_CRP_PLUGIN_URL . 'default.png',
				'size'    => 'large',
			),
		);
	...
	public static function settings_features() {
		$settings = array(
			...
			'features_display_header'        => array(
				...
				'desc' => esc_html__( 'Control the blocks, widget, and page builder integrations registered by Contextual Related Posts.', 'contextual-related-posts' ),
				'type' => 'header',
			),
			'enable_blocks'                  => array(
				'id'      => 'enable_blocks',
				'name'    => esc_html__( 'Related Posts block', 'contextual-related-posts' ),
				'desc'    => esc_html__( 'Registers the Related Posts block for the block editor.', 'contextual-related-posts' ),
				'type'    => 'checkbox',
				'default' => 1,
			),
			'enable_legacy_widgets'          => array(
				'id'      => 'enable_legacy_widgets',
				'name'    => esc_html__( 'Legacy widget', 'contextual-related-posts' ),
			...
			'enable_query_block'             => array(
				...
				'name'    => esc_html__( 'Query Loop block', 'contextual-related-posts' ),
				'desc'    => esc_html__( 'Registers the Contextual Related Posts Query Loop variation and its block patterns.', 'contextual-related-posts' ),
				'type'    => 'checkbox',
				'default' => 1,
				'pro'     => true,
			),
			'enable_featured_image_block'    => array(
				...
				'name'    => esc_html__( 'Featured Image block', 'contextual-related-posts' ),
				'desc'    => esc_html__( 'Extends the core Featured Image block with Contextual Related Posts image fallbacks.', 'contextual-related-posts' ),
				'type'    => 'checkbox',
				'default' => 1,
				'pro'     => true,
			),
			'enable_related_posts_pro_block' => array(
				'id'      => 'enable_related_posts_pro_block',
				'name'    => esc_html__( 'Related Posts Pro block', 'contextual-related-posts' ),
				'desc'    => esc_html__( 'Registers the Related Posts Pro block for the block editor.', 'contextual-related-posts' ),
				'type'    => 'checkbox',
				'default' => 1,
				'pro'     => true,
			),
			'enable_page_builders'           => array(
				...
				'name'    => esc_html__( 'Page builder integrations', 'contextual-related-posts' ),
				'desc'    => esc_html__( 'Registers the Related Posts elements for Elementor, Bricks Builder, and WPBakery Page Builder.', 'contextual-related-posts' ),
				'type'    => 'checkbox',
				'default' => 1,
				'pro'     => true,
			),
			'features_optimization_header'   => array(
				'id'   => 'features_optimization_header',
				'name' => '<h3>' . esc_html__( 'Optimization and feeds', 'contextual-related-posts' ) . '</h3>',
				'desc' => esc_html__( 'Control feed output and optional performance modules.', 'contextual-related-posts' ),
				'type' => 'header',
			),
			'enable_feed'                    => array(
				'id'      => 'enable_feed',
				'name'    => esc_html__( 'Related posts in feeds', 'contextual-related-posts' ),
				'desc'    => esc_html__( 'Adds related posts to feeds when feeds are selected in the General settings tab.', 'contextual-related-posts' ),
				'type'    => 'checkbox',
				'default' => 1,
			),
			'enable_bot_protection'          => array(
				'id'      => 'enable_bot_protection',
				'name'    => esc_html__( 'Bot protection module', 'contextual-related-posts' ),
				'desc'    => esc_html__( 'Loads the bot detection module. Enable Bot Protection on the General settings tab to use it.', 'contextual-related-posts' ),
				'type'    => 'checkbox',
				'default' => 1,
				'pro'     => true,
			),
			'enable_lazy_load'               => array(
				'id'      => 'enable_lazy_load',
				'name'    => esc_html__( 'Lazy load module', 'contextual-related-posts' ),
				'desc'    => esc_html__( 'Loads the lazy loading module. Enable Lazy Load Related Posts on the Performance tab to use it.', 'contextual-related-posts' ),
				'type'    => 'checkbox',
				'default' => 1,
				'pro'     => true,
			),
			...
			'enable_custom_tables'           => array(
				...
				'name'    => esc_html__( 'Custom tables module', 'contextual-related-posts' ),
				'desc'    => esc_html__( 'Loads Efficient Content Storage and Indexing (ECSI) and its related tools. Enable Use Custom Tables on the Performance tab to use it.', 'contextual-related-posts' ),
				'type'    => 'checkbox',
				'default' => 1,
				'pro'     => true,
			),
