...
class Styles_Handler {
	 ...
	 * requested by a `[crp]`/`[crp_related_posts]` shortcode or `crp_related_posts` Elementor
	 * widget on the queried post are loaded — Gutenberg block instances aren't scanned here,
