...
?>
	<p>
		<label for="thumb_meta"><?php _e( 'Location of thumbnail:', 'contextual-related-posts' ); ?></label>
	...
	<p>
		<label for="crp_disable_here"><?php _e( 'Disable Related Posts display:', 'contextual-related-posts' ); ?></label>
	...
	<p>
		<label for="thumb_meta"><?php _e( 'Manual related posts:', 'contextual-related-posts' ); ?></label>
