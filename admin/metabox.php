...
?>
	...
	<p>
		<label for="thumb_meta"><strong><?php esc_html_e( 'Location of thumbnail:', 'contextual-related-posts' ); ?></strong></label>
...
function crp_save_meta_box( $post_id ) {
	...
	if ( isset( $_POST['thumb_meta'] ) ) {
		$thumb_meta = empty( $_POST['thumb_meta'] ) ? '' : ( $_POST['thumb_meta'] );
	}
